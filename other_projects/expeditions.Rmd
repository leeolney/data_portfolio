...
* Section 2: Predicting the outcome (success) of the expedition i.e., survived or not survived. 
  + modeling workflow reference: [Julia Siege's walkthrough](https://juliasilge.com/blog/himalayan-climbing/)   
